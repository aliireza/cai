...
def parse_arguments():
    ...
    parser.add_argument('-c', '--compile', action='store_true', default=True, help='Enable compilation check')
    parser.add_argument('-v', '--verify', action='store_true', default=False, help='Enable verification check')
    parser.add_argument('-p', '--performance', action='store_true', default=False, help='Enable performance check')
    parser.add_argument('-comp', '--compiler', type=str, required=False, choices=['gcc', 'clang'], default='clang', help='Compiler to use')
